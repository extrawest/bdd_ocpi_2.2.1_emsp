...
public class SessionResponseBddHandler extends IncomingMessageFieldsFactory<Session>
        implements ResponseMessageFactory<Session> {
    ...
    @Override
    public void validateAndAssertFieldsWithParams(Map<String, String> params, Session message) {
